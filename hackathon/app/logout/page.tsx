...
const page = () => {
  return (
    <div>
       ...
       <Image src="logout.webp" alt="n" className='h-52'/>
       <div className='ml-7'>
       ...
       <Link href="/"><button className='bg-[#2A254B] text-white font-Satoshi px-5 py-3 rounded hover:bg-[#3A336B]'>Log in Again</button></Link>
       </div>
       </div>
